        ...
        <td class="container" bgcolor="#FFFFFF">
            ...
            <div class="content head">
                <table>
                    <tr>
                        <td style="width: 50%">
                            <h2>The Techknow Space</h2>
                            <p>
                                33 City Centre Dr.<br/>
                            ...
                            <table class="summarytable">
                                <tr>
                                    ...
                                    <td class="headright" style="width: 25%">
                                        ${{ $account->AccountBalance - $receivable->OriginalAmount }}<br/>
                                        ${{ $newCharges }}<br/>
                                        ${{ $newPayments }}<br/>
                                        =======================<br/>
            ...
            <div class="content">
                ...
                <tbody>
                    <tr>
                        <td>TR-{{ $lastTransaction->TransactionNumber }}</td>
                        <td>{{ $lastTransaction->Time }}</td>
                        {{-- <td></td> --}}
                        <td>
                            @foreach($lastTransactionEntry as $lineItem)
                            @endforeach
                        </td>
                        <td></td>
                        <td></td>
